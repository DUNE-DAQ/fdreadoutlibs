...
#ifndef WIB2_TPG_PROCESSNAIVE_HPP_
#define WIB2_TPG_PROCESSNAIVE_HPP_
...
process_window_naive(ProcessingInfo<NREGISTERS>& info)
{
  ...
  std::cout << "Finished performing SWTPG naive implementation. Found " << nhits << " hits. \n";
  
}



#endif // WIB2_TPG_PROCESSNAIVE_HPP_
