#ifndef FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_REFACTOREDDAPHNEETHSTREAMTYPEADAPTER_
#define FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_REFACTOREDDAPHNEETHSTREAMTYPEADAPTER_
...
namespace dunedaq::fdreadoutlibs::types {
  ...
  class RefactoredDAPHNEEthStreamTypeAdapter : public TypeAdapter<fddetdataformats::DAPHNEEthStreamFrame,
								  NumFrames{1},
  ...
  public:
    void fake_timestamps(uint64_t first_timestamp,
			 uint64_t offset = RefactoredDAPHNEEthStreamTypeAdapter::expected_tick_difference) {
...
#endif // FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_REFACTOREDDAPHNEETHSTREAMTYPEADAPTER_
