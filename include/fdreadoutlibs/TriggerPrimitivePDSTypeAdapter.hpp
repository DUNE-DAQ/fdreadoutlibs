#ifndef FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_SW_PROTOWIB_TRIGGERPRIMITIVEPDSTYPEADAPTER_HPP_
#define FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_SW_PROTOWIB_TRIGGERPRIMITIVEPDSTYPEADAPTER_HPP_
...
const constexpr std::size_t kTriggerPrimitivePDS = sizeof(trgdataformats::TriggerPrimitivePDS);

struct TriggerPrimitivePDSTypeAdapter
{

  using FrameType = TriggerPrimitivePDSTypeAdapter;
  // data
  trgdataformats::TriggerPrimitivePDS tp;
  // comparable based on start timestamp
  bool operator<(const TriggerPrimitivePDSTypeAdapter& other) const
  {
  ...
  size_t get_payload_size() { return kTriggerPrimitivePDS; }

  size_t get_num_frames() { return 1; }

  size_t get_frame_size() { return kTriggerPrimitivePDS; }
...
static_assert(sizeof(struct TriggerPrimitivePDSTypeAdapter) == sizeof(trgdataformats::TriggerPrimitivePDS),
              "Check your assumptions on TriggerPrimitivePDSTypeAdapter");

} // namespace types
} // namespace fdreadoutlibs
} // namespace dunedaq

#endif // FDREADOUTLIBS_INCLUDE_FDREADOUTLIBS_SW_PROTOWIB_TRIGGERPRIMITIVEPDSTYPEADAPTER_HPP_
